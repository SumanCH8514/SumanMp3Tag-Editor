  ...
  return (
    <div className="min-h-screen flex flex-col text-white">
      ...
      <footer className="py-6 border-t border-white/10 bg-black/20 text-center text-white/40 text-sm">
        <p>
          © {new Date().getFullYear()} <a href="https://sumanonline.likesyou.org/SumanMp3Tag/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">SumanMp3Tag Editor</a>. Secure client-side processing Project.
          <br />
