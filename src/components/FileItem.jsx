...
import { Music, Video, Edit2, Trash2, CheckCircle, Loader2 } from 'lucide-react';

const FileItem = ({ file, onEdit, onRemove, status }) => {
  const isVideo = file.type.startsWith('video');

  return (
    <div className="p-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl flex items-center gap-4 transition-colors group">
